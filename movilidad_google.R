...
provincia <- st_read("Provincia_2010.shp")

movilidad_google_buenos_aires_provincia <- movilidad_google %>% filter(sub_region_1 == "Buenos Aires Province")
summary(movilidad_google_buenos_aires_provincia$sub_region_2)
